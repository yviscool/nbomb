...
const debug = require('debug')('nuke:loader');

/**
 * Load files from directory to target object.
 * @since 1.0.0
 */
export class FileLoader extends EggFileLoader {
        ...
        for (const directory of directories) {
            ...
            for (const filepath of filepaths) {
                ...
                if (is.class(wrapClass)) {
                    (wrapClass as any ).prototype.pathName = pathName;
                    (wrapClass as any ).prototype.fullPath = fullpath;
                }
